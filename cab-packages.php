...
<html lang="en">
  <head>
    ...
    <!-- custom css  -->
    <link rel="stylesheet" href="css/cab-packages.css">
    <link rel="stylesheet" href="css/header.css">
    <link rel="stylesheet" href="css/footer.css">
    <link rel="stylesheet" href="css/our-team.css">
    <link rel="stylesheet" href="css/authority.css">
    <link rel="stylesheet" href="css/cab-packages-media-query.css">

    <!-- google fonts  -->
    <link rel="preconnect" href="https://fonts.gstatic.com">
    <link href="https://fonts.googleapis.com/css2?family=Ubuntu:wght@300;400;500&display=swap" rel="stylesheet">

    <title>Upcarz - Cab Packages</title>
  ...
  <body>
    ...
    <section id="section_main" class="mt-3">
        <div class="container-fluid">
            ...
            <!-- cab packages start -->
            <div id="cab_packages" class="row">
                <h1 class="heading">CAB PACKAGES</h1>

                <?php 
                    include("partials/db.php");

                    $sql = "SELECT * FROM cab_packages ORDER BY id";
